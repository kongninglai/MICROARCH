module stage_rr_tb;
    ...
    begin
        ...
        print_from_rr_sigs();
        // $display("dstidA=%0d, dstidB=%0d", from_rr_dstidA, from_rr_dstidB);
        // $display("srcregA=%08h, srcregB=%08h, srcregC=%08h", from_rr_srcregA, from_rr_srcregB, from_rr_srcregC);
        // $display("srcSREG=%04h, MMA=%016h, MMB=%016h", from_rr_srcSREG, from_rr_MMA, from_rr_MMB);
        // $display("imm=%08h", from_rr_imm);
        // $display("sreg1=%04h, slim1=%05h", from_rr_sreg1, from_rr_slim1);
        // $display("base1=%08h, index1=%08h, disp=%08h", from_rr_base1, from_rr_index1, from_rr_disp);
        // $display("sreg2=%04h, slim2=%04h", from_rr_sreg2, from_rr_slim2);
        // $display("base2=%08h", from_rr_base2);
        // $display("intex_vec=%0b", from_rr_intex_vec);
        // $display("oeip=%08h, ieip=%08h", from_rr_oeip, from_rr_ieip);
