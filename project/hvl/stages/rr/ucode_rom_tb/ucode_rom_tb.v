...
begin 
    ...
    #2
    $display("ucode=%96b", ucode_sig);
    $display("ldAB=%02b, gprd0_mux=%03b, gprd2_mux=%02b, eflags_mux=%03b, gp_dsta_mux=%04b, store_data_mux=%04b, rw=%02b, ds=%02b", ldAB, gprd0_mux, gprd2_mux, eflags_mux, gp_dsta_mux, store_data_mux, rw, ds);
    $display("mem_ds=%02b, imm_mux=%02b, addr_mux=%02b\n", mem_ds, imm_mux, addr_mux);
end
endtask
