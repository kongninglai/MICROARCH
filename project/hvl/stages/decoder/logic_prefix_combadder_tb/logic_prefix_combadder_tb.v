...
module comb_logic_gen_tb();
    ...
    wire [2:0] result = {OUT2, OUT1, OUT0};
    ...
    initial begin
        ...
        check_case(4'b0010, 3'd1, "1 Prefix");
        check_case(4'b0011, 3'd2, "2 Prefix");
        check_case(4'b0100, 3'd1, "1 Prefix");
        check_case(4'b0101, 3'd2, "2 Prefix");
        check_case(4'b0110, 3'd2, "2 Prefix");
        check_case(4'b0111, 3'd3, "3 Prefix");
        check_case(4'b1000, 3'd1, "2 Prefix");
        check_case(4'b1001, 3'd2, "2 Prefix");
        check_case(4'b1010, 3'd2, "2 Prefix");
        check_case(4'b1011, 3'd3, "3 Prefix");
        check_case(4'b1100, 3'd2, "2 Prefix");
        check_case(4'b1101, 3'd3, "3 Prefix");
        check_case(4'b1110, 3'd3, "3 Prefix");
        check_case(4'b1111, 3'd4, "4 Prefix");
