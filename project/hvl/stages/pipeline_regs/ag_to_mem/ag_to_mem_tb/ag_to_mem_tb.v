module ag_to_mem_tb;
    ...
    wire [53:0]    from_ag_control_sigs;
    ...
    stage_ag dut_ag(
        ...
        .to_mem_control_sigs(from_ag_control_sigs),
        .to_mem_dstidA(from_ag_dstidA),
        .to_mem_dstidB(from_ag_dstidB),
        .to_mem_srcregA(from_ag_srcregA),
        .to_mem_srcregB(from_ag_srcregB),
        .to_mem_srcregC(from_ag_srcregC),
        .to_mem_srcSREG(from_ag_srcSREG),
        .to_mem_MMA(from_ag_MMA),
        .to_mem_MMB(from_ag_MMB),

        .to_mem_target_cs(from_ag_target_cs),
        .to_mem_ld_addr(from_ag_ld_addr),
        .to_mem_ld_offset(from_ag_ld_offset),
        .to_mem_ld_slim(from_ag_ld_slim),
        .to_mem_st_addr(from_ag_st_addr),
        .to_mem_st_offset(from_ag_st_offset),
        .to_mem_st_slim(from_ag_st_slim),
        .to_mem_inc_esp(from_ag_inc_esp),
        .to_mem_dec_esp(from_ag_dec_esp),
        .to_mem_imm(from_ag_imm),
        .to_mem_rel_eip(from_ag_rel_eip),

        .to_mem_cs(from_ag_cs),
        .to_mem_oeip(from_ag_oeip),
        .to_mem_ieip(from_ag_ieip),
        .to_mem_valid(from_ag_valid)
    );
    ...
    begin 
        ...
        $display("oeip=%08h, ieip=%08h, cs=%04h", from_ag_oeip, from_ag_ieip, from_ag_cs);
        $display("valid=%0b", from_ag_valid);
        $display("\n");
    end
    endtask
