...
# 	TopLevel.1
# 	TopLevel.2
#   Source.1: tb_intgr_fshifter_decode.uut.STAGE_DECODE
#   Wave.1: 28 signals
#   Group count = 1
...
catch {gui_list_expand -id ${Hier.1} tb_intgr_fshifter_decode}
catch {gui_list_expand -id ${Hier.1} tb_intgr_fshifter_decode.uut}
catch {gui_list_select -id ${Hier.1} {tb_intgr_fshifter_decode.uut.FETCH_BUFF}}
...
gui_list_show_data -id ${Data.1} {tb_intgr_fshifter_decode.uut.FETCH_BUFF}
gui_show_window -window ${Data.1}
catch { gui_list_select -id ${Data.1} {tb_intgr_fshifter_decode.uut.FETCH_BUFF.clk tb_intgr_fshifter_decode.uut.FETCH_BUFF.rst_bar }}
...
gui_open_source -id ${Source.1}  -replace -active tb_intgr_fshifter_decode.uut.STAGE_DECODE /home/ecelrc/students/aak3265/MICROARCH/project/hdl/stages/decoder/stage_decode.v
