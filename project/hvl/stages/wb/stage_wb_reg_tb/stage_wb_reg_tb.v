module stage_wb_reg_tb;
    ...
    wb_sig dut_wb_sig(
        ...
        .gpwr0_en(from_ex_gpwr0_en),
        .gpwr1_en(from_ex_gpwr1_en),
        .segwr_en(from_ex_segwr_en),
        .mmxwr_en(from_ex_mmxwr_en),
    ...
    begin 
        $display("----------------------------------------------------------------");
        $display("dstA_size=%02b, dstB_size=%02b", from_ex_dstA_size, from_ex_dstB_size);
        $display("gpwr0_en=%0b, gpwr1_en=%0b, segwr_en=%0b, mmxwr_en=%0b", from_ex_gpwr0_en, from_ex_gpwr1_en, from_ex_segwr_en, from_ex_mmxwr_en);
