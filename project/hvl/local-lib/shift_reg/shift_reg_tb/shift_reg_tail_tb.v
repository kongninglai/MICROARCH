module shift_reg_tail_tb;

initial begin
  // $vcdplusfile("shift_reg_tail_tb.dump.vpd");
  // $vcdpluson(0, shift_reg_tail_tb);
  // $vcdpluson(0, shift_reg_tail_tb.dut.q);
end
...
always @(posedge clk) begin
  ...
  if (tail_ptr_exp !== 5'd0) begin
    mask = (256'b1 << (tail_ptr_exp * 8)) - 1'b1;
...
always @(posedge clk) begin
  inbytes <= {$random, $random, $random, $random, $random, $random, $random, $random};
end
