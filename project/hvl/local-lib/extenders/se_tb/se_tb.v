...
se          #(.INP_WIDTH(INP_WIDTH), .OUT_WIDTH(OUT_WIDTH))
            DUT_se (.in(in), .out(out));
            
se_behav    #(.INP_WIDTH(INP_WIDTH), .OUT_WIDTH(OUT_WIDTH))
            REF_se (.in(in), .out(out_behav));
