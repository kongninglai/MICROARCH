...
initial begin
  // $vcdplusfile("HA_16b_tb.dump.vpd");
  // $vcdpluson(0, HA_16b_tb); 
end
...
HA_16b DUT(.s(out[2*WIDTH-1:WIDTH]), .cout(out[WIDTH-1:0]), .in0(in0), .in1(in1));

HA_16b_behav REF(.s(out_exp[2*WIDTH-1:WIDTH]), .cout(out_exp[WIDTH-1:0]), .in0(in0), .in1(in1));
