...
decoder5_32 DUT(.SEL(SEL), .Y(out[2*OUT_WIDTH-1:OUT_WIDTH]), .YBAR(out[OUT_WIDTH-1:0]));

decoder5_32_behav REF(.SEL(SEL), .Y(out_exp[2*OUT_WIDTH-1:OUT_WIDTH]), .YBAR(out_exp[OUT_WIDTH-1:0]));
