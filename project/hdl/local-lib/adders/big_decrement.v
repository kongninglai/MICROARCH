...
wire  [WIDTH-1:0]  a_inv_buf64;

bufferHInv64$ bufferHInv64$_a_inv_buf64[WIDTH-1:0](a_inv_buf64, a);
...
generate
  for (i = 1; i < WIDTH; i = i + 1) begin : carry_generation
    big_and #(.WIDTH(i)) big_and_inst(c[i], a_inv_buf64[i-1:0]);
  end
endgenerate
