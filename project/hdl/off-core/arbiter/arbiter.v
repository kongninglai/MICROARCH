...
wire    NOBODY_BUSY, NOBODY_BUSY_buf16;
...
bufferH16$    bufferH16$_NOBODY_BUSY_buf16(NOBODY_BUSY_buf16, NOBODY_BUSY);
...
inv1$ inv_4(DC_DMA_WR_RQ_bar, DC_DMA_WR_RQ);
wire Q2_bar;
wire IC_MEM_RD_RQ_bar;
inv1$ inv_6(IC_MEM_RD_RQ_bar, IC_MEM_RD_RQ);
wire DC_DMA_RD_RQ_bar;
inv1$ inv_7(DC_DMA_RD_RQ_bar, DC_DMA_RD_RQ);
wire DC_KB_WR_RQ_bar;
inv1$ inv_8(DC_KB_WR_RQ_bar, DC_KB_WR_RQ);
wire Q0_bar;
...
wire nand_0_2_0_out;
wire nand_0_3_0_out;
nand4$ nand_0_0_0(nand_0_0_0_out,nand_0_1_0_out,nand_0_3_0_out,nand_0_2_0_out,NOBODY_BUSY_buf16);
and4$ nand_0_1_0(nand_0_1_0_out,Q1_bar,Q0_bar,DC_MEM_RD_RQ_bar,DC_DMA_RD_RQ_bar);
and4$ nand_0_2_0(nand_0_2_0_out,Q2_bar,DC_KB_RD_RQ_bar,DC_MEM_WR_RQ_bar,DC_DMA_WR_RQ_bar);
and3$ nand_0_3_0(nand_0_3_0_out,DC_KB_WR_RQ_bar,IC_MEM_RD_RQ_bar,DMA_MEM_WR_RQ);
wire nand_1_0_0_out;
wire nand_1_1_0_out;
wire nand_1_2_0_out;
wire nand_1_3_0_out;
nand4$ nand_1_0_0(nand_1_0_0_out,nand_1_1_0_out,Q2_bar,NOBODY_BUSY_buf16,Q0_bar);
and4$ nand_1_1_0(nand_1_1_0_out,nand_1_2_0_out,Q1_bar,DC_MEM_RD_RQ_bar,DC_DMA_RD_RQ_bar);
...
wire nand_2_0_0_out;
wire nand_2_1_0_out;
nand4$ nand_2_0_0(nand_2_0_0_out,nand_2_1_0_out,Q2_bar,NOBODY_BUSY_buf16,Q0_bar);
and2$ nand_2_1_0(nand_2_1_0_out,Q1_bar,DC_KB_WR_RQ);
wire nand_3_0_0_out;
wire nand_3_1_0_out;
nand4$ nand_3_0_0(nand_3_0_0_out,nand_3_1_0_out,Q2_bar,NOBODY_BUSY_buf16,Q0_bar);
and2$ nand_3_1_0(nand_3_1_0_out,Q1_bar,DC_DMA_WR_RQ);
wire nand_4_0_0_out;
wire nand_4_1_0_out;
nand4$ nand_4_0_0(nand_4_0_0_out,nand_4_1_0_out,Q2_bar,NOBODY_BUSY_buf16,Q0_bar);
and2$ nand_4_1_0(nand_4_1_0_out,Q1_bar,DC_MEM_WR_RQ);
wire nand_5_0_0_out;
...
nand3$ nand_12_0_0(nand_12_0_0_out,Q2_prebuf,Q1_bar_prebuf,Q0_prebuf);
wire nand_13_0_0_out;
wire nand_13_1_0_out;
nand4$ nand_13_0_0(nand_13_0_0_out,nand_13_1_0_out,Q2_bar,NOBODY_BUSY_buf16,Q0_bar);
and2$ nand_13_1_0(nand_13_1_0_out,Q1_bar,DC_KB_RD_RQ);
wire nand_14_0_0_out;
wire nand_14_1_0_out;
nand4$ nand_14_0_0(nand_14_0_0_out,nand_14_1_0_out,Q2_bar,NOBODY_BUSY_buf16,Q0_bar);
and2$ nand_14_1_0(nand_14_1_0_out,Q1_bar,DC_DMA_RD_RQ);
wire nand_15_0_0_out;
wire nand_15_1_0_out;
nand4$ nand_15_0_0(nand_15_0_0_out,nand_15_1_0_out,Q2_bar,NOBODY_BUSY_buf16,Q0_bar);
and2$ nand_15_1_0(nand_15_1_0_out,Q1_bar,DC_MEM_RD_RQ);
