...
generate
  ...
  for (i = 0; i < NUM_SETS; i = i + 1) begin : LRU_STORE_TOUCH_VALIDS_GEN
    ...
    wire                      SB_HIT_CONDITION, HIT_CONDITION, HIT_CONDITION_buf16, CACHE_MISS;
    ...
    if (TRUE_LRU == 0) begin : PSEUDO_LRU_GEN
      ...
      inv1$   inv1_CACHE_MISS(CACHE_MISS, CACHE_HIT_buf16);
      and2$   and2$_SB_HIT_CONDITION(SB_HIT_CONDITION, CC_STREAM_BUF_HIT, CACHE_MISS);
