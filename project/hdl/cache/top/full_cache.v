...
wire    STOREQ_STORING_buf64;

bufferH64$    bufferH64$_STOREQ_STORING_buf64(STOREQ_STORING_buf64, STOREQ_STORING);
...
mux2$   mux2$_DCACHE_PHYS_ADDR[MEM_ADDR_WIDTH-1:RANK_BURST_SIZE](DCACHE_PHYS_ADDR, {D_RD_TLB_PFN_OUT, MEM_PAGE_OFFSET[PAGE_BIT_WIDTH-1:RANK_BURST_SIZE]}, STOREQ_PHYS_ADDR, STOREQ_STORING_buf64);
...
wire DCC_FSM_VALID_WR_EN_GLOBAL_REG, DCC_FSM_VALID_WR_EN_GLOBAL_BAR, DCC_FSM_VALID_WR_EN_GLOBAL_BAR_buf16, DCC_FSM_VALID_WR_EN_GLOBAL_buf16;
...
bufferH16$    bufferH16$_DCC_FSM_VALID_WR_EN_GLOBAL_BAR_buf16(DCC_FSM_VALID_WR_EN_GLOBAL_BAR_buf16, DCC_FSM_VALID_WR_EN_GLOBAL_BAR);
...
wire DCACHE_HIT_WITH_ACCESS, DCACHE_STREAM_BUF_HIT_WITH_ACCESS_buf16;
...
lru_store #(.TRUE_LRU(TRUE_LRU)) lru_store_DCACHE_VICT_WAY (
  ...
  .CC_STREAM_BUF_HIT(DCACHE_STREAM_BUF_HIT_WITH_ACCESS_buf16),
...
generate 
  for (j = 0; j < NUM_WAYS; j = j + 1) begin : DCACHE_VALID_AND_TAG_HIT_GEN
    and3$   and3$_DCACHE_HIT_ALL_WAYS(DCACHE_HIT_ALL_WAYS[j], DCACHE_TAG_HIT[j], DCACHE_VALID_OUT[j], DCC_FSM_VALID_WR_EN_GLOBAL_BAR_buf16);
  end
endgenerate


bufferH16$  bufferH16$_DCACHE_HIT_buf16(DCACHE_HIT, DCACHE_HIT_prebuf);

mux4$   mux4$_DCACHE_HIT( DCACHE_HIT_prebuf, 
                          DCACHE_HIT_ALL_WAYS[0], DCACHE_HIT_ALL_WAYS[1], DCACHE_HIT_ALL_WAYS[2], DCACHE_HIT_ALL_WAYS[3],
                          DCACHE_TAG_HIT_WAY[0], DCACHE_TAG_HIT_WAY[1]);
...
nor2$     nor2$_DCACHE_GENERAL_MISS(DCACHE_GENERAL_MISS, DCACHE_HIT_prebuf, DCC_STREAM_BUF_HIT);

wire  VALID_CACHE_OPERATION;
or2$      or2$_VALID_CACHE_OPERATION(VALID_CACHE_OPERATION, MEM_VALID_LOAD_INST_buf16, STOREQ_STORING_buf64);

wire  VALID_CACHE_OPERATION_BAR;
nor2$     nor2$_VALID_CACHE_OPERATION_BAR(VALID_CACHE_OPERATION_BAR, MEM_VALID_LOAD_INST_buf16, STOREQ_STORING_buf64);

nor2$   nor2$_DCACHE_MISS(DCACHE_MISS, DCACHE_HIT_prebuf, VALID_CACHE_OPERATION_BAR);

wire    DCACHE_MISS_BAR, DIRTY_VICTIM_BAR;
inv1$   inv1$_DIRTY_VICTIM_BAR(DIRTY_VICTIM_BAR, DIRTY_VICTIM);
inv1$   inv1$_DCACHE_MISS_BAR(DCACHE_MISS_BAR, DCACHE_MISS);
nor2$   nor2$_DIRTY_WB_NEEDED(DIRTY_WB_NEEDED, DIRTY_VICTIM_BAR, DCACHE_MISS_BAR);

wire DIRTY_WB_NEEDED_BAR;
nand2$  nand2$_DIRTY_WB_NEEDED_BAR(DIRTY_WB_NEEDED_BAR, DIRTY_VICTIM, DCACHE_MISS);
...
wire MEM_IO_MISS_BAR;
nand2$  nand2$_DCACHE_MISS_TO_CC(DCACHE_MISS_TO_CC, DCACHE_MISS_BAR, MEM_IO_MISS_BAR);

wire WB_VALID_IO_STORE_INST_buf1024_BAR;
inv1$   inv1$_WB_VALID_IO_STORE_INST_buf1024_BAR(WB_VALID_IO_STORE_INST_buf1024_BAR, WB_VALID_IO_STORE_INST_buf1024);
nand2$    nand2$_DCACHE_NEED_WR_BUS(DCACHE_NEED_WR_BUS, DIRTY_WB_NEEDED_BAR, WB_VALID_IO_STORE_INST_buf1024_BAR);
...
nand3$  nand3$_THREE_STALL_REASONS(THREE_STALL_REASONS, FILL_BUSY_BAR, WBE_BUSY_BAR, THIRD_STALL_REASON);

wire  STOREQ_STORING_bar;
inv1$   inv1_STOREQ_STORING_bar(STOREQ_STORING_bar, STOREQ_STORING_buf64);

/* Importantly, stream buffer hits DO NOT MEAN a STOREQ hit!!! */
wire    STOREQ_LAST_ENTRY_BAR, STOREQ_STALL_CONDITION_BAR, STOREQ_STALL_CONDITION;
inv1$   inv1$_STOREQ_LAST_ENTRY_BAR(STOREQ_LAST_ENTRY_BAR, STOREQ_LAST_ENTRY);
nor2$   nor2$_STOREQ_STALL_CONDITION_BAR(STOREQ_STALL_CONDITION_BAR, DCACHE_MISS, STOREQ_LAST_ENTRY_BAR);
inv1$   inv1$_STOREQ_STALL_CONDITION(STOREQ_STALL_CONDITION, STOREQ_STALL_CONDITION_BAR);
nor2$   nor2$_STOREQ_MISS(STOREQ_MISS, STOREQ_STORING_bar, STOREQ_STALL_CONDITION_BAR);
...
wire    STOREQ_MISS_BAR, MEM_NO_IO_MISS_BAR;
nand2$  nand2$_STOREQ_MISS_BAR(STOREQ_MISS_BAR, STOREQ_STORING_buf64, STOREQ_STALL_CONDITION);
nand3$  nand3$_MEM_NO_IO_MISS_BAR(MEM_NO_IO_MISS_BAR, MEM_VALID_LOAD_INST_buf16, DCACHE_GENERAL_MISS, D_RD_TLB_CACHE_ENABLE_OUT);
nand3$  nand3$_MEM_IO_MISS_BAR(MEM_IO_MISS_BAR, MEM_VALID_LOAD_INST_buf16, D_RD_TLB_CACHE_DISABLE, STICKY_BAR);
wire    THREE_OTHER_STALL_REASONS;
...
// ~STOREQ_STORING || (STOREQ_LAST_ENTRY && ~DCACHE_MISS)
// = ~(STOREQ_STORING && ~((STOREQ_LAST_ENTRY && ~DCACHE_MISS)))

wire v3, v4;
nand2$   nand2$_v3(v3, STOREQ_LAST_ENTRY, DCACHE_HIT_prebuf);
nand2$   nand2$_v4(v4, v3, STOREQ_STORING);
nand3$   nor3$_DCACHE_STALL_IF_MEM_BAR(DCACHE_STALL_IF_MEM_BAR, NEITHER_BUSY, v4, w1);
...
wire  VALID_LOAD_AND_CACHE_ENABLE, ACCESS_COND;
and2$   and2$_VALID_LOAD_AND_CACHE_ENABLE(VALID_LOAD_AND_CACHE_ENABLE, MEM_VALID_LOAD_INST_buf16, D_RD_TLB_CACHE_ENABLE_OUT);
or2$    or2$_ACCESS_COND(ACCESS_COND, VALID_LOAD_AND_CACHE_ENABLE, STOREQ_STORING_buf64);

and3$   and3$_DCACHE_HIT_WITH_ACCESS(DCACHE_HIT_WITH_ACCESS, DCACHE_HIT, VALID_CACHE_OPERATION, ACCESS_COND);

wire DCACHE_STREAM_BUF_HIT_WITH_ACCESS;
nand4$   nand4$_DCACHE_STREAM_BUF_HIT_WITH_ACCESS(DCACHE_STREAM_BUF_HIT_WITH_ACCESS, DCC_STREAM_BUF_HIT, VALID_CACHE_OPERATION, D_RD_TLB_CACHE_ENABLE_OUT, STOREQ_STORING_bar);
bufferHInv16$   bufferHInv16$_DCACHE_STREAM_BUF_HIT_WITH_ACCESS_buf16(DCACHE_STREAM_BUF_HIT_WITH_ACCESS_buf16, DCACHE_STREAM_BUF_HIT_WITH_ACCESS);
...
wire    ICACHE_HIT;
wire    ICACHE_HIT_WITH_ACCESS, ICACHE_STREAM_BUF_HIT_WITH_ACCESS_buf16, ITLB_NO_PAGE_FAULT_OUT;
...
lru_store #(.TRUE_LRU(TRUE_LRU)) lru_store_ICACHE_VICT_WAY (
  ...
  .CC_STREAM_BUF_HIT(ICACHE_STREAM_BUF_HIT_WITH_ACCESS_buf16),
...
wire ICACHE_STREAM_BUF_HIT_WITH_ACCESS;
nand2$     nand2$_ICACHE_STREAM_BUF_HIT_WITH_ACCESS(ICACHE_STREAM_BUF_HIT_WITH_ACCESS, ICC_STREAM_BUF_HIT, ITLB_NO_PAGE_FAULT_OUT);
bufferHInv16$   bufferHInv16$_ICACHE_STREAM_BUF_HIT_WITH_ACCESS_buf16(ICACHE_STREAM_BUF_HIT_WITH_ACCESS_buf16, ICACHE_STREAM_BUF_HIT_WITH_ACCESS);
