...
nand2$  nand2$_THIRD_STALL_REASON(THIRD_STALL_REASON, DOUBLE_WBE_NOT_BUSY, DCACHE_NEED_WR_BUS);
...
and2$   and2$_STOREQ_MISS(STOREQ_MISS, STOREQ_STORING_buf64, STOREQ_STALL_CONDITION);
...
wire    STOREQ_MISS_BAR, MEM_NO_IO_MISS_BAR, MEM_IO_MISS_BAR;
