module regfile_seg #(
    ...
    wire [WIDTH-1:0] rd_reg0_raw, rd_reg1_raw, rd_reg2_raw;
    ...
    mux8 mux_reg2_raw[WIDTH-1:0](rd_reg2_raw, q[0], q[1], q[2], q[3], q[4], q[5], q[6], q[7], rd_reg2_idx[0], rd_reg2_idx[1], rd_reg2_idx[2]);
