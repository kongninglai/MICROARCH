...
module fetch_buffer(
    ...
    mux16_32 we_mask_mux(
        .Y(wr_en_w),
        .IN0({{15{1'b0}}, {16{1'b1}}}), 
        .IN1({{14{1'b0}}, {16{1'b1}}, {1{1'b0}}}), 
        .IN2 ({{13{1'b0}}, {16{1'b1}}, {2{1'b0}}}),   // bits [17:2]
        .IN3 ({{12{1'b0}}, {16{1'b1}}, {3{1'b0}}}),   // bits [18:3]
        .IN4 ({{11{1'b0}}, {16{1'b1}}, {4{1'b0}}}),   // bits [19:4]
        .IN5 ({{10{1'b0}}, {16{1'b1}}, {5{1'b0}}}),   // bits [20:5]
        .IN6 ({{9{1'b0}},  {16{1'b1}}, {6{1'b0}}}),   // bits [21:6]
        .IN7 ({{8{1'b0}},  {16{1'b1}}, {7{1'b0}}}),   // bits [22:7]
        .IN8 ({{7{1'b0}},  {16{1'b1}}, {8{1'b0}}}),   // bits [23:8]
        .IN9 ({{6{1'b0}},  {16{1'b1}}, {9{1'b0}}}),   // bits [24:9]
        .IN10({{5{1'b0}},  {16{1'b1}}, {10{1'b0}}}),  // bits [25:10]
        .IN11({{4{1'b0}},  {16{1'b1}}, {11{1'b0}}}),  // bits [26:11]
        .IN12({{3{1'b0}},  {16{1'b1}}, {12{1'b0}}}),  // bits [27:12]
        .IN13({{2{1'b0}},  {16{1'b1}}, {13{1'b0}}}),  // bits [28:13]
        .IN14({1'b0,        {16{1'b1}}, {14{1'b0}}}),  // bits [29:14]
        .IN15({{16{1'b1}}, {15{1'b0}}}),               // bits [30:15]
