module de_to_rr(
    ...
    input wire from_de_addressing_mode,
    ...
    //decoder output
    output wire [5:0] to_rr_prefixes, //{prefix_rep, prefix_op_size, prefix_reg_ov_id, prefix_ext}
    ...
    output wire to_rr_addressing_mode,
    ...
    wire [218:0] reg_out;
    reg_de_to_rr PR_DR_TO_RR(.CLK(clk), .CLR(rst), .en(from_de_ld_pr), .Din(reg_in), .Q(reg_out));
