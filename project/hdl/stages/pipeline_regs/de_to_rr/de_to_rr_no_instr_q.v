    module de_to_rr_no_instr_q(
        ...
        input wire from_de_pred_dir,
        input wire [3:0] from_de_pht_idx,
        ...
        assign reg_in = {from_f_exception_flags, from_de_i_eip, from_de_o_eip, from_de_bp_target, from_de_pr_valid, 
                        ...
                        from_de_imm_size, from_de_imm, from_de_addressing_mode, from_de_instr_length, from_de_ucode_sigs, from_de_pred_dir, from_de_pht_idx};

        wire [321:0] reg_out;
        reg_de_to_rr #(.WIDTH(322)) PR_DR_TO_RR(.CLK(clk), .CLR(rst), .en(from_de_ld_pr), .Din(reg_in), .Q(reg_out));
        assign {to_rr_exception_flags, to_rr_i_eip, to_rr_o_eip, to_rr_bp_target, to_rr_pr_valid, 
                ...
                to_rr_imm_size, to_rr_imm, to_rr_addressing_mode, to_rr_instr_length, to_rr_ucode_sigs, to_rr_pred_dir, to_rr_pht_idx} = reg_out;
