module ag_to_mem(
    ...
    input we,
    input flush_bar,
    input [58:0]     from_ag_control_sigs,
    ...
    output [58:0]     to_mem_control_sigs,
    ...
    wire [755:0] reg_din, reg_q, reg_qb;
    ...
    reg_ag_to_mem reg_ag_to_mem(clk, reg_din, reg_q, reg_qb, rst_or_flush, 1'b1, we);
