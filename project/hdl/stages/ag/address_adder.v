module address_adder(
    ...
    wire [31:0] datasize;
    mux4_32 mux_datasize(datasize, 32'h0, 32'h1, 32'h3, 32'h7, size_mux[0], size_mux[1]);

    wire [31:0] sum_sreg1_index1, sum_base1_disp1, sum_index1_size;
    PA_32b PA_sreg_index(.s(sum_sreg1_index1), .in0(scaled_index1), .in1(shifted_sreg1));
    PA_32b PA_base_disp(.s(sum_base1_disp1), .in0(base1), .in1(disp1));
    PA_32b PA_index_size(.s(sum_index1_size), .in0(scaled_index1), .in1(datasize));

    PA_32b PA_addr1(.s(addr1), .in0(sum_sreg1_index1), .in1(sum_base1_disp1));
    PA_32b PA_offset1(.s(offset1), .in0(sum_index1_size), .in1(sum_base1_disp1));
    ...
    mux4_32 mux_esp_dec_size(esp_dec_size, 32'hFFFFFFFF, 32'hFFFFFFFE, 32'hFFFFFFFC, 32'hFFFFFFF8, size_mux[0], size_mux[1]);
    mux4_32 mux_esp_inc_size(esp_inc_size, 32'h1, 32'h2, 32'h4, 32'h8, size_mux[0], size_mux[1]);
    ...
    PA_32b PA_addr2(.s(addr2), .in0(sum_base2), .in1(shifted_sreg2));
    PA_32b PA_offset2(.s(offset2), .in0(sum_base2), .in1(datasize));
