...
wire ldEFLAGS, ldEIP, ldCS, alu_srcb_mux, shf_op, movs0, movs1, cmps0, cmps1, cmps2, cmpxchg, cmovc, seg_dst_mux, rm, op_ovr, palu_size, sbb_dir, iret0;
...
and3$   and3$_LINE_0_LOAD_DONE(LINE_0_LOAD_DONE, DCACHE_STALL, DOING_LINE_1_LOAD_BAR, MEM_VALID_LOAD_INST);
...
and3$   and3$_LINE_1_LOAD_DONE(LINE_1_LOAD_DONE, DCACHE_STALL, DOING_LINE_1_LOAD_buf16, MEM_VALID_LOAD_INST);
...
nand2$  nand2$_from_mem_stall(from_mem_stall, DCACHE_STALL, STALL_REASON_1_bar);
