...
module logic_true_modrm(
    ...
    mux8_8 choose_imm_size_inbytes(.Y(imm_size_inbytes_temp), .IN0({5'd0, imm_size_inbytes0}), .IN1({5'd0, imm_size_inbytes1}), .IN2({5'd0, imm_size_inbytes2}), .IN3({5'd0, imm_size_inbytes3}), .IN4({5'd0, imm_size_inbytes4}), .IN5(8'd0), .IN6(8'd0), .IN7(8'd0), .S0(prefix_num[0]), .S1(prefix_num[1]), .S2(prefix_num[2]));
    mux8_8 choose_imm_size(.Y(imm_size_temp), .IN0({6'd0, imm_size0}), .IN1({6'd0, imm_size1}), .IN2({6'd0, imm_size2}), .IN3({6'd0, imm_size3}), .IN4({6'd0, imm_size4}), .IN5(8'd0), .IN6(8'd0), .IN7(8'd0), .S0(prefix_num[0]), .S1(prefix_num[1]), .S2(prefix_num[2]));
