...
module logic_true_modrm(
    ...
    wire [7:0] sum_temp;
    mux8_8 choose_modrm(.Y(modrm_byte_true), .IN0(candidate_opcode0), .IN1(candidate_opcode1), .IN2(candidate_opcode2), .IN3(candidate_opcode3), .IN4(candidate_opcode4), .IN5(8'd0), .IN6(8'd0), .IN7(8'd0), .S0(prefix_num[0]), .S1(prefix_num[1]), .S2(prefix_num[2]));
