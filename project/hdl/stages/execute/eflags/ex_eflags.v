module ex_eflags(
    ...
    mux8_32 mux_eflags_value(eflags_value, alu_eflags, shf_eflags, bsf_eflags, aaa_eflags, cmp_eflags, 32'h0, 32'h400, , sig_eflags_mux[0], sig_eflags_mux[1], sig_eflags_mux[2]);
    mux8_32 mux_eflags_mux(eflags_mask, alu_eflags_mask, shf_eflags_mask, bsf_eflags_mask, aaa_eflags_mask, cmp_eflags_mask, 32'h400, 32'h400, , sig_eflags_mux[0], sig_eflags_mux[1], sig_eflags_mux[2]);

    mux2_32 mux_eflags_din[31:0](eflags_din, eflags_q, eflags_value, eflags_mask);
